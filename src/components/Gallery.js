...
const Gallery = ({images}) => {
    ...
    return (
        <div className='gallery relative h-[400px] w-full'>
            <LightGallery
                onInit={onInit}
                speed={500}
