          ...
          <div className='footer-top py-14 grid lg:grid-cols-2'>
            <div className='footer-topLeft flex justify-center items-center flex-col'>
              ...
              <div className='social-links flex gap-4 items-center mb-10 lg:mb-0' data-aos="fade-up">
                <Link className='w-10 h-10 rounded-full bg-greenMain hover:bg-greenDark flex items-center justify-center transition-all' href={"https://www.facebook.com/profile.php?id=61566027237719"} target='_blank'>
                ...
                <Link className='w-10 h-10 rounded-full bg-greenMain hover:bg-greenDark flex items-center justify-center transition-all' href={"https://www.instagram.com/kerlincampos_/"} target='_blank'>
                ...
                <Link className='w-10 h-10 rounded-full bg-greenMain hover:bg-greenDark flex items-center justify-center transition-all' href={"https://www.linkedin.com/company/kerlin-bienesraices/"} target='_blank'>
